            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="user.register.label" default="Register" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: userInstance, field: "register")}</td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="user.phone.label" default="Phone" /></td>
